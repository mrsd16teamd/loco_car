    ...
    for(std::vector<int>::iterator it=objID.begin();it!=objID.end();it++)
        { cout<<"Inside the for loop\n";
            ...
            switch(*it)
            {
                ...
                case 0: { 
                            publish_cloud(pub_cluster0,cluster_vec[i],input);
                ...
                case 1: {
                            publish_cloud(pub_cluster1,cluster_vec[i],input);
                            publishedCluster[i]=true;//Use this flag to publish only once for a given obj ID
                            i++;
                            break;
                ...
                case 2: {
                            publish_cloud(pub_cluster2,cluster_vec[i],input);
                            publishedCluster[i]=true;//Use this flag to publish only once for a given obj ID
                            i++;
                            break;
                ...
                case 3: {
                            publish_cloud(pub_cluster3,cluster_vec[i],input);
                            publishedCluster[i]=true;//Use this flag to publish only once for a given obj ID
                            i++;
                            break;
                ...
                case 4: {
                            publish_cloud(pub_cluster4,cluster_vec[i],input);
                            publishedCluster[i]=true;//Use this flag to publish only once for a given obj ID
                            i++;
                            break;
                ...
                case 5: {
                            publish_cloud(pub_cluster5,cluster_vec[i],input);
                            publishedCluster[i]=true;//Use this flag to publish only once for a given obj ID
                            i++;
                            break;
