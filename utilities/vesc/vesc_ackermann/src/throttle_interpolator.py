...
class InterpolateThrottle:
    def __init__(self):
        ...
        self.input_topic = rospy.get_param('~output_topic', '/commands/motor/unsmoothed_speed')
        self.output_topic = rospy.get_param('~input_topic', '/commands/motor/speed')
        self.max_delta_rpm = rospy.get_param('max_delta_rpm')
        self.max_rpm = rospy.get_param('speed_max')
        self.min_rpm = rospy.get_param('speed_min')
