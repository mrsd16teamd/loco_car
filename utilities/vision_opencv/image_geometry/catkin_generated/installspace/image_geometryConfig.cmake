...
if("FALSE" STREQUAL "TRUE")
  ...
  set(image_geometry_DEVEL_PREFIX /home/ubuntu/catkin_ws/src/devel)
...
if(NOT "include;/opt/ros/indigo/include/opencv-3.1.0-dev/opencv;/opt/ros/indigo/include/opencv-3.1.0-dev " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'image_geometry' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/usr/local/${idir}'.  Ask the maintainer 'Vincent Rabaud <vincent.rabaud@gmail.com>' to fix it.")
    endif()
